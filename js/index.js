...
$.getJSON('http://ec2-34-203-220-97.compute-1.amazonaws.com:8080/test', function(data) {
	...
	var marker1 = new google.maps.Marker({
	    ...
	    map: map,
        content: "<html><h2>Donut Fantasy</h2><p>Type: Dessert</p><p>Distance: 5.23 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
	...
	var marker2 = new google.maps.Marker({
	  	position: new google.maps.LatLng($latitude, $longitude),
	    map: map,
        content: "<html><h2>Snow Go!</h2><p>Type: Dessert</p><p>Distance: 5.99 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
    ...
    var marker3 = new google.maps.Marker({
	  	position: new google.maps.LatLng($latitude, $longitude),
	    map: map,
        content: "<html><h2>Strings Italian Food</h2><p>Type: Italian</p><p>Distance: 3.89 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
	...
	var marker4 = new google.maps.Marker({
	  	position: new google.maps.LatLng($latitude, $longitude),
	    map: map,
        content: "<html><h2>Tacos El Amigo</h2><p>Type: Mexican</p><p>Distance: 2.46 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
	...
	var marker5 = new google.maps.Marker({
	  	position: new google.maps.LatLng($latitude, $longitude),
	    map: map,
        content: "<html><h2>Happy Wok</h2><p>Type: Chinese</p><p>Distance: 4.89 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
	...
	var marker6 = new google.maps.Marker({
	  	position: new google.maps.LatLng($latitude, $longitude),
	    map: map,
        content: "<html><h2>Thai Country</h2><p>Type: Thai</p><p>Distance: 4.48 mi</p></html>",
	    visible: true,
	 	icon: '2.png',
	});
    ...
    var marker7 = new google.maps.Marker({
	  	position: new google.maps.LatLng(36.813625, -119.751426),
        content: "<html><h3>Food truck name</h3><p>Food type</p><html>",
	    map: map,
	    visible: true,
